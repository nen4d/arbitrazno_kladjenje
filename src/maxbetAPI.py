...
# URL of the API
api_url = 'https://www.maxbet.rs/restapi/offer/sr/sport/S/mob?annex=3&desktopVersion=1.0.1.1&locale=sr'

#https://www.maxbet.rs/restapi/offer/sr/sport/S/mob?annex=3&date=09.06.2024&desktopVersion=1.0.1.1&locale=sr
...
with open('maxbet.csv', 'w', newline='', encoding='utf-8') as f:
